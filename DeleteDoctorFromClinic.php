...
<body style="background-image: url(Images/Pic10.jpg);">
    ...
    <center>
        <h1 style="font-family: cursive">REMOVE DOCTOR FROM A CLINIC</h1>
        <hr>
        <form method="post" action=""> 
            ...
            <!-- <select name="doctor" id="doctor-list">
                <option value="" style="font-family: cursive">Select Doctor & Schedule</option>
            </select> -->
        ...
        if(isset($_POST['submit']))
        {
            ...
            $cid = intval($_POST['clinic']);
            $rest = intval($_POST['doctor']);
            ...
            if($cid > 0 && $rest > 0) {
                ...
                echo "<p style='color:red;'>Please select both Clinic and Doctor.</p>";
            }
        }   
        ?> 
    </center>
